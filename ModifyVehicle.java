	...
	{	 
		...
		try
		{
		   ...
		   // pw.println("connected"); 
			...
			pw.println("<form action='http://server:8080/servlet/DisplayVehicle'>");
			pw.println("<h3> SELECT THE VEHICLE NO TOM MODITY :<select name=vno>");
			/*while(rs.next())
			{
			...
			pw.println("</select></H3><BR><BR><CENTER><input type=SUBMIT value='MODIFY'>");
