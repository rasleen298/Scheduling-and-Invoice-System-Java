...
import java.sql.*;
public class DeleteVehicle1 extends HttpServlet
{	 int j;
	ResultSet rs;
	...
	{	 
		...
		try
		{
		   ...
		   // pw.println("connected"); 
			...
			PreparedStatement ps = c.prepareStatement("delete from vehicle where vehicleno='"+vno+"'");
			j = ps.executeUpdate();
			pw.println("RECORD DELETED SUCCESSFULLY"); 
			if(j==1)
			{
			pw.println("THE ROUTE "+vno+" DELETED SUCCESSFULLY");
			}
